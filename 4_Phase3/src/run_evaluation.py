...
def evaluate_against_ground_truth(predictions_path, ground_truth_path, output_dir):
    ...
    try:
        ...
        # Save evaluation results in competition format
        metrics_path = os.path.join(output_dir, 'metrics.json')
        with open(metrics_path, 'w') as f:
            json.dump(evaluation_results, f, indent=2)
            
        # Also save detailed evaluation metrics
...
def create_final_summary(output_dir, mode, job_info, evaluation_results=None):
    ...
    # Add detailed evaluation metrics if ground truth evaluation was performed
...
def main():
    ...
    if not args.model_path:
        args.model_path = "models/hybrid.pth"
