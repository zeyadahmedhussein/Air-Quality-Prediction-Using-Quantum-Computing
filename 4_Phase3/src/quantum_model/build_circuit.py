...
class ErrorCalibrationGenerator:
    ...
    def __init__(self, n_qubits=4, n_layers=3, n_calibration_samples=100000):
    ...
    def _setup_quantum_devices(self):
        ...
        # Try to setup noisy device (fallback to simulation)
        try:
            ...
            print("⚠ Noisy device not available, will simulate noise")
            self.dev_noisy = None
            self.has_noisy_device = False
